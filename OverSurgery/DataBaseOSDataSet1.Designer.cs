...
namespace OverSurgery {
    ...
    public partial class DataBaseOSDataSet1 : global::System.Data.DataSet {
        ...
        public partial class PrescriptionDataTable : global::System.Data.TypedTableBase<PrescriptionRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public PrescriptionRow AddPrescriptionRow(int ID, string Name) {
        ...
        public partial class PrescriptionRow : global::System.Data.DataRow {
            ...
            public bool IsNameNull() {
                return this.IsNull(this.tablePrescription.NameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetNameNull() {
                this[this.tablePrescription.NameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace OverSurgery.DataBaseOSDataSet1TableAdapters {
    ...
    public partial class PrescriptionTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Prescription] WHERE (([ID] = @Original_ID) AND ((@IsNull_Name " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Prescription] ([ID], [Name]) VALUES (@ID, @Name);\r\nSELECT ID, " +
                "Name FROM Prescription WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Prescription] SET [ID] = @ID, [Name] = @Name WHERE (([ID] = @Origin" +
                "al_ID) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)))" +
                ";\r\nSELECT ID, Name FROM Prescription WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name FROM dbo.Prescription";
        ...
        public virtual int Fill(DataBaseOSDataSet1.PrescriptionDataTable dataTable) {
        ...
        public virtual DataBaseOSDataSet1.PrescriptionDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataBaseOSDataSet1.PrescriptionDataTable dataTable = new DataBaseOSDataSet1.PrescriptionDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataBaseOSDataSet1.PrescriptionDataTable dataTable) {
